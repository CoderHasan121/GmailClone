...
function SendMail() {
  ...
  return (   
      ...
      <hr />
      <textarea onChange={changeHandler}  value={formData.message} name="message"  placeholder="message" cols={30} rows={10} className="outline-none py-1"></textarea>
      <button className="rounded-full w-fit px-4 text-white font-medium bg-[#0B57D0] ">Send</button>
      </form>
