...
// ! ----- npm i framer-motion ----- Import Motions from framer-motion
import { motion } from "framer-motion";
import { DiUbuntu } from "react-icons/di";
// ! get the props from messages.jsx
const Message = ({ email }) => {
  ...
  return (
    // ! Use framer-motion to create a smooth and interactive animation for the message div.
    <motion.div
